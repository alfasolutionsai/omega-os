    ...
    <section className="relative min-h-screen w-full px-4 py-10">
      ...
      <div className="mx-auto w-full max-w-4xl space-y-8">
        ...
        <div className="py-2">
          <SectionColumns
            title="Votre Avatar"
            description="Un avatar est optionnel mais fortement recommandé."
          >
          ...
          <SectionColumns
            title="Votre Nom"
            description="Entrez le nom d'affichage que vous souhaitez utiliser dans OMEGA OS."
          >
            <div className="w-full space-y-1">
              ...
              <p className="text-muted-foreground text-xs">32 caractères max</p>
            </div>
          </SectionColumns>
          <Separator />
          <SectionColumns
            title="Votre Email"
            description="Adresse email principale pour les notifications et la sécurité."
          >
