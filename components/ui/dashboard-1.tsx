...
>(({ 
  ...
  return (
    <motion.div
      ref={ref}
      className={cn("w-full max-w-4xl p-6 bg-card text-card-foreground rounded-2xl border", className)}
          ...
          <Card className="h-full p-4 overflow-hidden rounded-xl">
            <CardContent className="p-2">
              <div className="flex items-center justify-between mb-4">
                <p className="font-medium text-muted-foreground">Agent Activity</p>
